...
CONFIG_PATH = ROOT / "configs" / "benchmark" / "mackay_tabular_variants.yaml"
RESULTS_CSV = ROOT / "results" / "mackay_tabular_variants_benchmark_timings.csv"
LOG_DIR = ROOT / "logs" / "mackay_tabular_variants_benchmark"
