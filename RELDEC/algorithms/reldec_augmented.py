"""Shim module that re-exports from top-level `reldec_augmented`.
"""

"""Augmented deep reldec algorithms (moved into algorithms package).

This module extends the deep DQN variants with augmented features.
"""
